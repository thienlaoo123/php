...
*/
$output = "Меня зовут: $name<br>";
$output .= "Мне $age лет<br>";
$output .= "Тип переменной \$name: " . gettype($name) . "<br>";
$output .= "Тип переменной \$age: " . gettype($age) . "<br>";

// Удаляем переменные
unset($name, $age);

// Проверяем, что переменные удалены
$output .= "После удаления - переменная \$name существует: " . (isset($name) ? 'да' : 'нет') . "<br>";
$output .= "После удаления - переменная \$age существует: " . (isset($age) ? 'да' : 'нет') . "<br>";
?>
<!DOCTYPE html>
<html lang="ru">
<head>
